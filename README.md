...
> I write about JavaScript, Svelte, Vue & Solana on **[redev.rocks](https://redev.rocks)**

<details>
<summary>Recent articles</summary>

- [Reverse Engineering a Solana Program: A Beginner's Guide](https://redev.rocks)
- [Security Considerations for Token-Gated Applications](https://redev.rocks)
- [Building Solana Wallet Auth with Svelte 5 and Supabase](https://redev.rocks)
- [Testing Svelte 5 Apps: A Practical Guide to Code Structure](https://redev.rocks)
- [Understanding Solana NFTs: A Complete Guide](https://redev.rocks)
- [Sign In With Solana: A Beginner's Guide to Web3 Authentication](https://redev.rocks)
- [Svelte 5 Runes: A Complete Guide for Vue Developers](https://redev.rocks)
